...
import (
	...
	"github.com/agent-auth/agent-auth-api/web/services/rolespermissions"
	"github.com/agent-auth/agent-auth-api/web/services/workspace"
...
type router struct {
	...
	rolesService     rolespermissions.RolesService
}
...
func NewRouter() Router {
	...
	return &router{
		...
		rolesService:     rolespermissions.NewRolesService(),
	}
}
