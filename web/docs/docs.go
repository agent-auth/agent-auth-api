...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/resourceservice.ResourceResponse"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/resourceservice.ResourceRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "resourceservice.ResourceRequest": {
            "type": "object",
            "properties": {
                "_id": {
                    "type": "string"
        ...
        "resourceservice.ResourceResponse": {
            "type": "object",
            "properties": {
                "_id": {
                    "type": "string"
